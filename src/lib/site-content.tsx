...
export const defaultTexts = {
  ...
  "pack.badge": "Pack Bienvenida",
  "pack.title": "Pack Bienvenida B",
  "pack.subtitle": "Matricúlate hoy y acelera tu graduación al volante.",
  "pack.price": "270 €",
  "pack.priceNote": "Pago único · sin sorpresas",
  "pack.f1": "Matrícula + Teórico completo",
  "pack.f2": "Acceso al Campus Virtual y App de Test",
  "pack.f3": "5 Prácticas de circulación",
  "pack.f4": "1 Examen práctico incluido",
  "pack.highlight": "¡SIN GASTOS DE TRAMITACIÓN!",
  "pack.highlightNote": "Ahorro directo en tu matrícula",
  "pack.cta": "Quiero Matricularme",
  "pack.formTitle": "Reserva tu Pack Bienvenida B",
  "pack.formSubtitle": "Déjanos tus datos y te llamamos para formalizar la matrícula.",
