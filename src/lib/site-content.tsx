...
export const defaultTexts = {
  ...
  "nav.cta": "¡MATRÍCULATE AHORA!",

  "pack.badge": "Matrículas",
  "pack.title": "Elige tu matrícula",
  "pack.subtitle": "Matricúlate hoy y acelera tu graduación al volante.",
  "pack.highlight": "¡SIN GASTOS DE TRAMITACIÓN!",
  "pack.highlightNote": "Ahorro directo en tu matrícula",

  "pack.b.title": "Matrícula Básica B",
  "pack.b.price": "60 €",
  "pack.b.subtitle": "La opción esencial para preparar tu teórico a tu ritmo.",
  "pack.b.f1": "Matrícula + Clases teóricas incluidas",
  "pack.b.f2": "1 Mes gratis de App de Test",
  "pack.b.f3": "Acceso al Campus Virtual",
  "pack.b.cta": "Matricularme en Básica",

  "pack.w.title": "Pack Bienvenida B",
  "pack.w.badge": "Más popular",
  "pack.w.price": "255 €",
  "pack.w.subtitle": "Tus primeras 5 prácticas a solo 27,81 €/clase.",
  "pack.w.f1": "Matrícula + Clases teóricas incluidas",
  "pack.w.f2": "1 Mes gratis de App de Test",
  "pack.w.f3": "Acceso al Campus Virtual",
  "pack.w.f4": "5 Prácticas de circulación",
  "pack.w.f5": "1 Examen práctico incluido",
  ...
  "trust.2.value": "+15 años",
  "trust.2.label": "Formando conductores",
  "trust.3.value": "2",
  ...
  "info.1.text": "Clases presenciales todos los días y tests ilimitados para llegar al examen con seguridad.",
  "info.2.title": "Formación práctica",
  "info.2.text": "Flota moderna y revisada, y prácticas por las zonas reales de examen.",
  "info.3.title": "Flexibilidad horaria",
  "info.3.text": "Tú nos dices cuándo puedes. Ajustamos tus prácticas a tu horario de estudios o trabajo, sin complicaciones.",
  ...
  "courses.1.date": "Por confirmar",
  "courses.1.title": "Intensivo teórico B",
  "courses.1.desc": "Dos semanas de clases diarias centradas en los puntos claves del exámen + tests guiados para aprobar a la primera.",
  "courses.1.badge": "35 plazas",
  "courses.1.cta": "Reservar plaza",
  "courses.2.date": "Del 6 al 17 de octubre",
  "courses.2.title": "Intensivo teórico B",
  "courses.2.desc": "Dos semanas de clases diarias centradas en los puntos claves del exámen + tests guiados para aprobar a la primera.",
  "courses.2.badge": "35 plazas",
  "courses.2.cta": "Reservar plaza",
  "courses.3.date": "Fechas a consultar",
  "courses.3.title": "Intensivo teórico B",
  "courses.3.desc": "Dos semanas de clases diarias centradas en los puntos claves del exámen + tests guiados para aprobar a la primera.",
  "courses.3.badge": "35 plazas",
